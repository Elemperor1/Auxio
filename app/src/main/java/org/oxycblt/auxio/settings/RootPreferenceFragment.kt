...
class RootPreferenceFragment : BasePreferenceFragment(R.xml.preferences_root) {
    ...
    override fun onPreferenceTreeClick(preference: Preference): Boolean {
        ...
        when (preference.key) {
            ...
            getString(R.string.set_key_security) -> {
                L.d("Navigating to security preferences")
                findNavController().navigateSafe(RootPreferenceFragmentDirections.securityPreferences())
            }
